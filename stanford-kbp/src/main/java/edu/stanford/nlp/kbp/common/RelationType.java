...
import static edu.stanford.nlp.kbp.common.NERTag.*;
 ...
 * consistency filters). <b>If you'd like to change only the output form of these relations, see
 * {@link OfficialOutputWriter}</b>.
 *
 * @author Gabor Angeli
 */
public enum RelationType {
  ...
  PER_CITY_OF_BIRTH                     ("per:city_of_birth",                       NERTag.PERSON,       Cardinality.SINGLE, new NERTag[]{ CITY, LOCATION },                                     new String[]{ "NNP" },      0.0358146961159769100 ),
  PER_CITY_OF_DEATH                     ("per:city_of_death",                       NERTag.PERSON,       Cardinality.SINGLE, new NERTag[]{ CITY, LOCATION },                                     new String[]{ "NNP" },      0.0102003332137774650 ),
  ...
  PER_COUNTRY_OF_BIRTH                  ("per:country_of_birth",                    NERTag.PERSON,       Cardinality.SINGLE, new NERTag[]{ COUNTRY, LOCATION },                                  new String[]{ "NNP" },      0.0223444134627622040 ),
  PER_COUNTRY_OF_DEATH                  ("per:country_of_death",                    NERTag.PERSON,       Cardinality.SINGLE, new NERTag[]{ COUNTRY, LOCATION },                                  new String[]{ "NNP" },      0.0060626395621941200 ),
  PER_EMPLOYEE_OF                       ("per:employee_of",                         NERTag.PERSON,       Cardinality.LIST,   new NERTag[]{ ORGANIZATION, COUNTRY, STATE_OR_PROVINCE, CITY},      new String[]{ "NNP" },      0.0335281901169719200 ),
  ...
  PER_STATE_OR_PROVINCES_OF_BIRTH       ("per:stateorprovince_of_birth",            NERTag.PERSON,       Cardinality.SINGLE, new NERTag[]{ STATE_OR_PROVINCE, LOCATION, },                       new String[]{ "NNP" },      0.0165825918941120660 ),
  PER_STATE_OR_PROVINCES_OF_DEATH       ("per:stateorprovince_of_death",            NERTag.PERSON,       Cardinality.SINGLE, new NERTag[]{ STATE_OR_PROVINCE, LOCATION, },                       new String[]{ "NNP" },      0.0050083303444366030 ),
  PER_STATE_OR_PROVINCES_OF_RESIDENCE   ("per:stateorprovinces_of_residence",       NERTag.PERSON,       Cardinality.LIST,   new NERTag[]{ STATE_OR_PROVINCE, LOCATION, },                       new String[]{ "NNP" },      0.0066787379528178550 ),
  ...
  PER_TITLE                             ("per:title",                               NERTag.PERSON,       Cardinality.LIST,   new NERTag[]{ TITLE, MODIFIER },                                    new String[]{ "NN" },       0.0334283995325751200 ),
  ...
  ORG_CITY_OF_HEADQUARTERS              ("org:city_of_headquarters",                NERTag.ORGANIZATION, Cardinality.SINGLE, new NERTag[]{ CITY, LOCATION },                                     new String[]{ "NNP" },      0.0555949254318473740 ),
  ORG_COUNTRY_OF_HEADQUARTERS           ("org:country_of_headquarters",             NERTag.ORGANIZATION, Cardinality.SINGLE, new NERTag[]{ COUNTRY, LOCATION },                                  new String[]{ "NNP" },      0.0580217167451493100 ),
  ...
  ORG_STATE_OR_PROVINCES_OF_HEADQUARTERS("org:stateorprovince_of_headquarters",     NERTag.ORGANIZATION, Cardinality.SINGLE, new NERTag[]{ STATE_OR_PROVINCE, LOCATION, },                       new String[]{ "NNP" },      0.0312619314829170100 ),
  ...
  ORG_WEBSITE                           ("org:website",                             NERTag.ORGANIZATION, Cardinality.SINGLE, new NERTag[]{ URL },                                                new String[]{ "NNP","NN" }, 0.0051544006201478640 ),
  ;
   ...
   * that has since changed (see {@link OfficialOutputWriter#officialRelationName(RelationType, edu.stanford.nlp.kbp.common.Props.YEAR)}).
   */
  ...
  /** Returns whether this relation encodes a city/region/country of residence */
   ...
   */
  public static final Map<RelationType, Set<RelationType>> plausibleOverlappingRelations = new HashMap<>();
  /**
   ...
   */
  public static final Map<NERTag, Set<RelationType>> slotTypeToRelations = new HashMap<>();
  ...
  static {
    ...
    plausibleOverlappingRelations.put(PER_STATE_OR_PROVINCES_OF_DEATH, new HashSet<>(Arrays.asList(new RelationType[]{PER_STATE_OR_PROVINCES_OF_BIRTH, PER_STATE_OR_PROVINCES_OF_RESIDENCE})));
    plausibleOverlappingRelations.put(PER_STATE_OR_PROVINCES_OF_BIRTH, new HashSet<>(Arrays.asList(new RelationType[]{PER_STATE_OR_PROVINCES_OF_RESIDENCE, PER_STATE_OR_PROVINCES_OF_DEATH})));
    plausibleOverlappingRelations.put(PER_SPOUSE, new HashSet<>(Arrays.asList(new RelationType[]{})));
    plausibleOverlappingRelations.put(PER_SCHOOLS_ATTENDED, new HashSet<>(Arrays.asList(new RelationType[]{PER_EMPLOYEE_OF, PER_STATE_OR_PROVINCES_OF_RESIDENCE, PER_STATE_OR_PROVINCES_OF_BIRTH})));
    plausibleOverlappingRelations.put(PER_PARENTS,new HashSet<>(Arrays.asList(new RelationType[]{})));
    plausibleOverlappingRelations.put(PER_MEMBER_OF, new HashSet<>(Arrays.asList(new RelationType[]{PER_STATE_OR_PROVINCES_OF_RESIDENCE, PER_STATE_OR_PROVINCES_OF_DEATH, PER_STATE_OR_PROVINCES_OF_BIRTH, PER_SPOUSE, PER_SCHOOLS_ATTENDED, PER_ORIGIN})));
    plausibleOverlappingRelations.put(PER_EMPLOYEE_OF, new HashSet<>(Arrays.asList(new RelationType[]{PER_STATE_OR_PROVINCES_OF_RESIDENCE, PER_STATE_OR_PROVINCES_OF_DEATH, PER_STATE_OR_PROVINCES_OF_BIRTH, PER_SCHOOLS_ATTENDED, PER_MEMBER_OF})));
    plausibleOverlappingRelations.put(PER_DATE_OF_BIRTH,new HashSet<>(Arrays.asList(new RelationType[]{})));
    plausibleOverlappingRelations.put(PER_COUNTRY_OF_DEATH, new HashSet<>(Arrays.asList(new RelationType[]{PER_COUNTRY_OF_BIRTH, PER_MEMBER_OF, PER_EMPLOYEE_OF})));
    plausibleOverlappingRelations.put(PER_COUNTRY_OF_BIRTH, new HashSet<>(Arrays.asList(new RelationType[]{PER_COUNTRY_OF_DEATH, PER_SCHOOLS_ATTENDED, PER_MEMBER_OF, PER_EMPLOYEE_OF})));
    plausibleOverlappingRelations.put(PER_COUNTRIES_OF_RESIDENCE, new HashSet<>(Arrays.asList(new RelationType[]{PER_STATE_OR_PROVINCES_OF_BIRTH, PER_SCHOOLS_ATTENDED, PER_MEMBER_OF, PER_EMPLOYEE_OF, PER_COUNTRY_OF_DEATH, PER_COUNTRY_OF_BIRTH})));
    plausibleOverlappingRelations.put(PER_CITY_OF_DEATH, new HashSet<>(Arrays.asList(new RelationType[]{PER_STATE_OR_PROVINCES_OF_DEATH, PER_STATE_OR_PROVINCES_OF_BIRTH, PER_SCHOOLS_ATTENDED, PER_MEMBER_OF, PER_EMPLOYEE_OF, PER_COUNTRY_OF_DEATH, PER_COUNTRY_OF_BIRTH})));
    plausibleOverlappingRelations.put(PER_CITY_OF_BIRTH, new HashSet<>(Arrays.asList(new RelationType[]{PER_SPOUSE, PER_SCHOOLS_ATTENDED, PER_MEMBER_OF, PER_EMPLOYEE_OF, PER_COUNTRY_OF_BIRTH, PER_COUNTRIES_OF_RESIDENCE, PER_CITY_OF_DEATH})));
    plausibleOverlappingRelations.put(PER_CITIES_OF_RESIDENCE, new HashSet<>(Arrays.asList(new RelationType[]{ PER_SCHOOLS_ATTENDED, PER_MEMBER_OF, PER_EMPLOYEE_OF, PER_CITY_OF_DEATH, PER_CITY_OF_BIRTH})));
    plausibleOverlappingRelations.put(PER_CHILDREN, new HashSet<>(Arrays.asList(new RelationType[]{})));
    plausibleOverlappingRelations.put(PER_ALTERNATE_NAMES, new HashSet<>(Arrays.asList(new RelationType[]{})));
    plausibleOverlappingRelations.put(ORG_SUBSIDIARIES, new HashSet<>(Arrays.asList(new RelationType[]{})));
    plausibleOverlappingRelations.put(ORG_STATE_OR_PROVINCES_OF_HEADQUARTERS, new HashSet<>(Arrays.asList(new RelationType[]{ORG_TOP_MEMBERS_SLASH_EMPLOYEES, ORG_SUBSIDIARIES})));
    plausibleOverlappingRelations.put(ORG_PARENTS, new HashSet<>(Arrays.asList(new RelationType[]{ORG_TOP_MEMBERS_SLASH_EMPLOYEES, ORG_STATE_OR_PROVINCES_OF_HEADQUARTERS})));
    plausibleOverlappingRelations.put(ORG_MEMBER_OF, new HashSet<>(Arrays.asList(new RelationType[]{ORG_TOP_MEMBERS_SLASH_EMPLOYEES, ORG_SUBSIDIARIES, ORG_STATE_OR_PROVINCES_OF_HEADQUARTERS, ORG_POLITICAL_RELIGIOUS_AFFILIATION, ORG_PARENTS, ORG_MEMBERS})));
    plausibleOverlappingRelations.put(ORG_FOUNDED_BY, new HashSet<>(Arrays.asList(new RelationType[]{ORG_TOP_MEMBERS_SLASH_EMPLOYEES, ORG_SUBSIDIARIES, ORG_STATE_OR_PROVINCES_OF_HEADQUARTERS, ORG_POLITICAL_RELIGIOUS_AFFILIATION, ORG_PARENTS})));
    plausibleOverlappingRelations.put(ORG_FOUNDED,new HashSet<>(Arrays.asList(new RelationType[]{ORG_NUMBER_OF_EMPLOYEES_SLASH_MEMBERS})));
    plausibleOverlappingRelations.put(ORG_DISSOLVED, new HashSet<>(Arrays.asList(new RelationType[]{ORG_NUMBER_OF_EMPLOYEES_SLASH_MEMBERS, ORG_FOUNDED})));
    plausibleOverlappingRelations.put(ORG_COUNTRY_OF_HEADQUARTERS, new HashSet<>(Arrays.asList(new RelationType[]{ORG_TOP_MEMBERS_SLASH_EMPLOYEES, ORG_SUBSIDIARIES, ORG_PARENTS, ORG_MEMBERS, ORG_MEMBER_OF, ORG_FOUNDED_BY})));
    plausibleOverlappingRelations.put(ORG_CITY_OF_HEADQUARTERS, new HashSet<>(Arrays.asList(new RelationType[]{ORG_SUBSIDIARIES, ORG_PARENTS, ORG_MEMBER_OF, ORG_FOUNDED_BY, ORG_COUNTRY_OF_HEADQUARTERS})));
    plausibleOverlappingRelations.put(ORG_ALTERNATE_NAMES, new HashSet<>(Arrays.asList(new RelationType[]{ORG_TOP_MEMBERS_SLASH_EMPLOYEES, ORG_STATE_OR_PROVINCES_OF_HEADQUARTERS, ORG_POLITICAL_RELIGIOUS_AFFILIATION, ORG_FOUNDED_BY, ORG_COUNTRY_OF_HEADQUARTERS, ORG_CITY_OF_HEADQUARTERS})));
    // -- Clean up the list
    for (Map.Entry<RelationType, Set<RelationType>> entry : plausibleOverlappingRelations.entrySet()) {
      Iterator<RelationType> iter = entry.getValue().iterator();
      while (iter.hasNext()) {
        RelationType cooccur = iter.next();
        if (entry.getKey().entityType != cooccur.entityType || CollectionUtils.intersect(entry.getKey().validNamedEntityLabels, cooccur.validNamedEntityLabels).isEmpty()) {
          iter.remove();
        }
      }
    }
    ...
    if (Utils.assertionsEnabled()) {
      for (RelationType rel : RelationType.values()) {
        for (NERTag validSlotTag : rel.validNamedEntityLabels) {
          assert slotTypeToRelations.get(validSlotTag).contains(rel);
        }
      }
      for (Map.Entry<NERTag, Set<RelationType>> entry : slotTypeToRelations.entrySet()) {
        for (RelationType rel : entry.getValue()) {
          assert rel.validNamedEntityLabels.contains(entry.getKey());
        }
      }
    }
  ...
  /**
   * Return all valid relations between the given entity and slot type.
   */
  public static Collection<RelationType> possibleRelationsBetween(NERTag entityType, NERTag slotType) {
    List<RelationType> rtn = new ArrayList<>();
    for (RelationType rel : slotTypeToRelations.get(slotType)) {
      if (rel.entityType == entityType) { rtn.add(rel); }
    }
    return rtn;
  }

  /**
   * The prior probability of each of the given relations, as calculated from the training
   * knowledge base.
   */
  public static final Counter<RelationType> priors = new ClassicCounter<RelationType>() {{
    for (RelationType rel : RelationType.values()) {
      setCount(rel, rel.priorProbability);
    }
