...
public class RelationMentionSnippets implements Serializable {
  ...
  // Note(gabor): Don't change these names! DirectFileQuerier depends on their .name() function.
  ...
  public RelationMentionSnippets(QueryType queryType, String entityName, String relationName, String slotValue) {
  ...
  public RelationMentionSnippets(String queryTypeName, String entityName, String relationName, String slotValue) {
    this.entityName = entityName;
    this.relationName = relationName;
    this.slotValue = slotValue;
  ...
  public RelationMentionSnippets(KBPSlotFill mention) {
    entityName = mention.key.entityName;
    relationName = mention.key.relationName;
    slotValue = mention.key.slotValue;
    this.snippets = new ArrayList<WebSnippet>();
  }
  ...
  public String toString() {
    ...
    // First line
    StringBuilder sb = new StringBuilder();
    sb.append(relationName).append(delimiter);
