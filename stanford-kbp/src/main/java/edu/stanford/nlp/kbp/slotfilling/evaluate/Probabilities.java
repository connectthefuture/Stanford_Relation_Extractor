...
public class Probabilities {
  ...
  public double ofSlotValueGivenRelationAndEntity(String slotFill, RelationType rel, KBPEntity entity) {
  ...
  public double ofRelationGivenEntity(RelationType rel, KBPEntity entity) {
  ...
  public double ofSlotValueGivenEntity(String slotFill, KBPEntity entity) {
