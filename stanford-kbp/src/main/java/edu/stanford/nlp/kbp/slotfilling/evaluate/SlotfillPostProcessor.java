...
public abstract class SlotfillPostProcessor {
  ...
  public Map<KBPEntity, List<KBPSlotFill>> postProcess(Map<KBPEntity, List<KBPSlotFill>> candidateAnswers, GoldResponseSet checklist) {
    Map<KBPEntity, List<KBPSlotFill>> filtered = new HashMap<>();
   ...
   */
  public abstract List<KBPSlotFill> postProcess(KBPEntity pivot, List<KBPSlotFill> slotFills, GoldResponseSet checklist);

  public final List<KBPSlotFill> postProcess(KBPEntity pivot, List<KBPSlotFill> slotFills) {
  ...
  public static final SlotfillPostProcessor unaryFilters = SlotfillPostProcessor.all(
      ...
      new HeuristicSlotfillPostProcessors.EmployeeFilter(),
   ...
   *
   * <p>These should ALWAYS come before the filters.</p>
   */
  public static final SlotfillPostProcessor unaryRewrites = SlotfillPostProcessor.all(
      ...
      new HeuristicSlotfillPostProcessors.DiedInRewrite(),
      new HeuristicSlotfillPostProcessors.AgeRewrite()
  );
  ...
  public static final SlotfillPostProcessor unary = SlotfillPostProcessor.all(
      unaryRewrites, unaryFilters  // rewrite before filtering
  );
