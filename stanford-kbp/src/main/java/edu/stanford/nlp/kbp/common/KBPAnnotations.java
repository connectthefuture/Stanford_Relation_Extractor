...
public class KBPAnnotations {
  ...
  /** An annotation that gets set in a pattern matching system that says whether a token is an entity */
  ...
  /** An annotation that gets set in a pattern matching system that says whether a token is a slot. */
